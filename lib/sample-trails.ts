...
export const sampleTrails: SampleTrail[] = [
  ...
  },
  {
    ...
    regionSlug: "okanagan",
    difficulty: "green",
    activityTypes: ["Mountain Biking", "Hiking", "ATV/UTV"],
    distanceKm: 18.6,
    elevationGainM: 210,
    durationMin: 90,
  ...
  },
  {
    ...
    regionSlug: "kamloops",
    difficulty: "blue",
    activityTypes: ["Skiing/Snowboarding"],
    distanceKm: 5.5,
    elevationGainM: 30,
    durationMin: 15,
  ...
  {
    id: "granby-backcountry-hunt",
    name: "Granby Backcountry Loop",
    region: "Kootenays",
    regionSlug: "kootenays",
    difficulty: "blue",
    activityTypes: ["Hunting", "Hiking"],
    distanceKm: 18.4,
    elevationGainM: 760,
    durationMin: 300,
    description: "A remote backcountry access route in the Granby River watershed. Dense old-growth timber transitions to open subalpine meadows — prime habitat for elk, mule deer, and black bear. Multi-day hunting access with established camp spots.",
    highlights: ["Elk habitat", "Old-growth forest", "Alpine meadows", "Remote access"],
    season: "Aug - Nov",
    coordinates: generatePath(49.2800, -118.6500, 820, 49.3400, -118.5800, 1680, 90, 0.007),
  },
  {
    id: "similkameen-horse-trail",
    name: "Similkameen River Corridor",
    region: "Okanagan",
    regionSlug: "okanagan",
    difficulty: "green",
    activityTypes: ["Horseback Riding", "Hiking"],
    distanceKm: 14.8,
    elevationGainM: 180,
    durationMin: 180,
    description: "A gentle riverside trail through sagebrush and ponderosa pine along the Similkameen River. Wide, well-maintained tread perfect for horses. Crosses three footbridges with views of the valley cliffs and river canyon below.",
    highlights: ["Riverside trail", "Sagebrush steppe", "River crossings", "Canyon views"],
    season: "Apr - Nov",
    coordinates: generatePath(49.3600, -119.6200, 340, 49.4200, -119.7100, 520, 70, 0.005),
  },
  {
    id: "fraser-river-fishing-access",
    name: "Nahatlatch River Access Route",
    region: "Fraser Valley",
    regionSlug: "fraser-valley",
    difficulty: "blue",
    activityTypes: ["Fishing", "Hiking", "Camping/Overlanding"],
    distanceKm: 9.6,
    elevationGainM: 420,
    durationMin: 120,
    description: "A rugged 4x4 and foot access route into the Nahatlatch River canyon — one of BC's best steelhead and chinook fisheries. The trail follows old logging spurs before dropping steeply to secluded river pools inaccessible by road.",
    highlights: ["Remote river pools", "Steelhead habitat", "Canyon access", "4x4 trailhead"],
    season: "Apr - Oct",
    coordinates: generatePath(49.7500, -121.7000, 380, 49.8100, -121.7500, 800, 60, 0.006),
  },
  {
    id: "callaghan-xc-loop",
    name: "Callaghan Valley XC Loop",
    region: "Whistler / Squamish",
    regionSlug: "whistler",
    difficulty: "blue",
    activityTypes: ["Cross-Country Skiing", "Snowshoeing"],
    distanceKm: 11.2,
    elevationGainM: 280,
    durationMin: 120,
    description: "A groomed cross-country ski loop through the Callaghan Valley — site of the 2010 Olympic Nordic events. Undulating terrain through old-growth forest with breathtaking views of Callaghan Lake and surrounding peaks.",
    highlights: ["Olympic venue", "Groomed track", "Old-growth forest", "Mountain views"],
    season: "Dec - Mar",
    coordinates: generatePath(50.1200, -123.0600, 920, 50.1700, -123.1100, 1200, 65, 0.004),
  },
  {
    id: "stawamus-chief-approach",
    name: "Stawamus Chief North Approach",
    region: "Whistler / Squamish",
    regionSlug: "whistler",
    difficulty: "black",
    activityTypes: ["Rock Climbing", "Hiking"],
    distanceKm: 4.2,
    elevationGainM: 520,
    durationMin: 90,
    description: "The approach trail to the North Peak of the Stawamus Chief — a 600m granite monolith and one of North America's premier trad climbing destinations. Steep forest trail with fixed ropes on the crux section, leading to multi-pitch climbing from the base.",
    highlights: ["Granite wall", "Multi-pitch climbing", "Forest approach", "Summit views"],
    season: "Apr - Oct",
    coordinates: generatePath(49.6750, -123.1550, 60, 49.6600, -123.1450, 580, 55, 0.003),
  },
];

export const regions = [
  { name: "Whistler / Squamish", slug: "whistler", trailCount: 6, lat: 50.07, lng: -122.95 },
  { name: "North Shore Vancouver", slug: "north-shore", trailCount: 2, lat: 49.37, lng: -123.08 },
  { name: "Kootenays", slug: "kootenays", trailCount: 4, lat: 49.08, lng: -118.20 },
  { name: "Okanagan", slug: "okanagan", trailCount: 2, lat: 49.82, lng: -119.40 },
  { name: "Kamloops", slug: "kamloops", trailCount: 1, lat: 50.89, lng: -119.91 },
  { name: "Fraser Valley", slug: "fraser-valley", trailCount: 2, lat: 49.10, lng: -121.96 },
];
